...
interface HomePageClientProps {
    ...
    mainArtisan: TeamMember | null;
    pageContent: PageContent[];
    testimonials: Testimonial[];
}

// This component contains all the client-side logic that was previously in page.tsx
export default function HomePageClient({ 
  ...
  // Data is now passed as props, so we don't need the useEffect to fetch data.
  // The loading state can be simplified or removed if data is always present.
